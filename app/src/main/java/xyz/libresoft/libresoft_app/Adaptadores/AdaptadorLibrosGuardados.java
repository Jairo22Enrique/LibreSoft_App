...
public class AdaptadorLibrosGuardados extends RecyclerView.Adapter<AdaptadorLibrosGuardados.adaptadorHolder>{

    List<Elemen> ListaElemen;

    public AdaptadorLibrosGuardados(List<Elemen> listaElemen) {
...
holder.contenedor.setOnLongClickListener(new View.OnLongClickListener() {
    ...
    public boolean onLongClick(View v) {
        ...
        String a="Eliminar libro de guardados";
        ...
        builder.setItems(opciones, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (opciones[i].equals("Eliminar libro de guardados")){
    ...
    @Override
    public void onBindViewHolder(AdaptadorLibrosGuardados.adaptadorHolder holder, int position) {
        try {
