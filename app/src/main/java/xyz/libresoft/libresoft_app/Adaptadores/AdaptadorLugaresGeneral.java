...
public class AdaptadorLugaresGeneral extends RecyclerView.Adapter<AdaptadorLugaresGeneral.adaptadorHolder>{

    List<ElemenBusarLugares> ListaElemen;

    public AdaptadorLugaresGeneral(List<ElemenBusarLugares> listaElemen) {
...
holder.contenedor.setOnClickListener(new View.OnClickListener() {
    ...
    @Override
    public void onBindViewHolder(AdaptadorLugaresGeneral.adaptadorHolder holder, int position) {
        try{
        holder.txtNombre.setText(ListaElemen.get(position).getNombreLugar().toString());
        holder.txtDisponibles.setText("Tel: "+ListaElemen.get(position).getTelefono().toString());
