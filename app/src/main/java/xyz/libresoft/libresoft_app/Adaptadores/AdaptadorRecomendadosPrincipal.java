...
public class AdaptadorRecomendadosPrincipal extends RecyclerView.Adapter<AdaptadorRecomendadosPrincipal.adaptadorHolder>{

    List<Elemen> ListaElemen;

    public AdaptadorRecomendadosPrincipal(List<Elemen> listaElemen) {
    ...
    /*    View vista= LayoutInflater.from(parent.getContext()).inflate(R.layout.elemento,parent,false);
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.elementorecomendadosprincipal, parent, false);
...
holder.contenedor.setOnClickListener(new View.OnClickListener() {
    ...
    @Override
    public void onBindViewHolder(AdaptadorRecomendadosPrincipal.adaptadorHolder holder, int position) {
        try {
            String a=ListaElemen.get(position).getTitulo().toString();
            if(a.length()>15){
                a=a.substring(0,15);
                a+="...";
            }
            holder.txtTitulo.setText(a);
    ...
    public int getItemCount() {
        ...
        public adaptadorHolder(View itemView) {
            super(itemView);
            contenedor=(LinearLayout) itemView.findViewById(R.id.contenedorrecomendadosprincipal);
            txtTitulo= (TextView) itemView.findViewById(R.id.txtTitulor);
            txtAutor= (TextView) itemView.findViewById(R.id.txtAutorr);
            txtGenero= (TextView) itemView.findViewById(R.id.txtGeneror);
            imagen=(ImageView) itemView.findViewById(R.id.Imagen);
            txtRating=(TextView) itemView.findViewById(R.id.txtRatingr);
        }
    }
}
